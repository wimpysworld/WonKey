...
Run the [build and test checks](../AGENTS.md#build-and-test) from the project root.
They use synthetic transports and temporary captures, without connected hardware.

The [protocol reference](protocol.md) records framing, configuration fields, and pinned source evidence.
...
See [hardware safety and records](hardware.md#apply-safety-and-records) before changing transaction order or capture completion.
